...
<style>
    ...
    <div class="form-group ">
        ...
        <div id="passwordContainer">
            <input type="password" id="pass" name="password" placeholder="Mot de passe" autocomplete="current-password" class="form-control pass-assist" maxlength="36" required="">
            <input type="text" id="passwordTx" style="display: none" class="form-control pass-assist" maxlength="36" aria-hidden="true" aria-invalid="false" aria-labelledby="passwordLabel" autocomplete="off" autocapitalize="none" spellcheck="false" autocorrect="off">
